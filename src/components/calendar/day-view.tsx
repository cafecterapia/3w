...
export function DayView({ date, slots, search, selectedSlots, onSelect }: DayViewProps) {
  ...
  return (
    <div className="rounded-lg border">
      ...
      {filtered.length === 0 ? (
        <div className="p-8 text-center text-sm text-gray-600">Sem horários disponíveis</div>
      ) : (
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between text-xs">
                  <div className="font-medium text-gray-900">{fmtTime(s.start)}</div>
